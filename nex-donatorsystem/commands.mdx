...
There's also a configurable keybind (default `F9`) — see [Configuration](/nex-donatorsystem/configuration#open-command--keybind).
...
Both commands also have GUI equivalents in the admin panel's Player Management tab — see [Admin panel → Player Management](/nex-donatorsystem/admin-panel#player-management).
