...
* [Installation](/nex-shoulderpets/installation)
* [Configuration](/nex-shoulderpets/configuration)
* [Adding pets](/nex-shoulderpets/adding-pets)
* [Player usage](/nex-shoulderpets/usage)
* [Commands](/nex-shoulderpets/commands)
* [Troubleshooting](/nex-shoulderpets/troubleshooting)
...
<Info>
  The bundled pet models are distributed as a separate stream resource. Download link is in [Installation → Pet models](/nex-shoulderpets/installation#pet-models).
</Info>
