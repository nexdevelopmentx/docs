...
* [Installation](/nex-queue/installation)
* [Discord setup](/nex-queue/discord-setup)
* [Configuration](/nex-queue/configuration)
* [Themes](/nex-queue/themes)
* [Whitelist & priority](/nex-queue/whitelist-and-priority)
* [Troubleshooting](/nex-queue/troubleshooting)
...
<Info>
  New here? Start with [Installation](/nex-queue/installation), then walk through [Discord setup](/nex-queue/discord-setup) to wire up the bot.
</Info>
