...
| Problem | Fix |
| ------- | --- |
| Server console prints `UI not compiled` in red | The `dist/` folder is missing. Download a release build, or build the NUI yourself (`cd web && bun install && bun run build`). |
