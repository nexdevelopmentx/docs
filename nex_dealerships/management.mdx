...
You can also pre-seed display cars in `shared/locations.lua` via the `DisplayVehicles = { ... }` field — see [Dealership lots](/nex_dealerships/dealerships#display-vehicles).
