---
title: "Admin panel"
description: "/dealershipadmin is the server-wide vehicle catalog editor and ownership manager. Run it in chat and the React UI opens; changes go live to every connected client immediately — no restart."
---
