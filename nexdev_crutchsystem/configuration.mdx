---
title: "Configuration"
description: "Everything lives in config.lua. Edit, then restart nexdev_crutchsystem."
---
...
Set any value to `false` or `''` to skip registering that command entirely. See [Commands](/nexdev_crutchsystem/commands) for the full reference.
