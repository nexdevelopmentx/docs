...
local vehicles = exports.nexdev_garages:GetPlayerVehicles(src)

-- One vehicle by plate (owner or shared access only)
local vehicle = exports.nexdev_garages:GetVehicle(src, plate)

-- Set a waypoint + blip to a left-out vehicle for the player
exports.nexdev_garages:TrackVehicle(src, plate)
```
