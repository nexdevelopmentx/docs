...
You don't need an MLO. Stand anywhere, run `/hoteladmin`, click **+ New Hotel**, and follow the steps in [Admin panel](/nex-hotels/admin-panel). Players see new hotels and rooms instantly — no restart needed.
