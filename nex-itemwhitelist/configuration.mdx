...
Everything lives in `config.lua`. The whitelist entries themselves are **not** in the config — they're in MySQL and managed from the [Admin menu](/nex-itemwhitelist/admin-menu).
