...
```lua
exports.nexdev_drugscreator:UseDrug(source, 'joint')
...
exports.nexdev_drugscreator:GiveTerritoryPoints(territoryId, factionName, points)
-- Adds territory-war points to a faction in a territory and syncs all clients.

exports.nexdev_drugscreator:ResetTerritoryPoints(territoryId)
